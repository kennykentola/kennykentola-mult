            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <a 
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-400 text-white shadow-[0_0_15px_-3px_rgba(16,185,129,0.4)] transition hover:opacity-90"
                ...
                <a href="#syllabus" className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/5 px-6 text-sm font-bold text-white transition-all hover:bg-white/10">
