...
export default function AdminLiveClassesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const loadClasses = useCallback(() => {
    ...
    const load = async () => {
      try {
        const res = await fetchAcademyLiveClasses(id);
  ...
  async function handleSave() {
    ...
    try {
      if (editingClass) {
        ...
        await createLiveClass(id, payload);
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-xl">
        ...
        <button
          ...
          className="bg-rose-600 hover:bg-rose-500 text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-rose-500/20"
        >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-xl overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <button onClick={openCreateForm} className="mt-6 text-rose-400 font-bold hover:text-rose-300">
              + Schedule Live Class
            </button>
          </div>
        ) : (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${
                      cls.status === 'ongoing' ? 'bg-rose-500/10 text-rose-400 border border-rose-500/20' :
          ...
          <div className="w-full max-w-lg bg-slate-900 rounded-2xl border border-slate-800 shadow-2xl p-6 md:p-8 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 py-3 rounded-xl bg-rose-600 hover:bg-rose-500 font-bold text-white transition-colors disabled:opacity-50 flex justify-center items-center gap-2 shadow-lg shadow-rose-500/20"
              >
