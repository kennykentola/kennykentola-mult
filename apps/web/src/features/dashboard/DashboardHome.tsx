...
import { academyOverview, academyStats, enrolledCourses as fallbackEnrolledCourses } from '../academy/content';
import { AcademyProgressResponse, fetchAcademyProgress } from '../academy/api';
